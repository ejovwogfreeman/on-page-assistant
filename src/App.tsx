...
import techie from "./assets/bubble.gif";
...
function App() {
  ...
  const handleClick = (e: React.MouseEvent<HTMLButtonElement>) => {
    const messageData = (e.target as HTMLElement).getAttribute("data-message");
          ...
          <div className="">
            <div className="content">
              <h1 className="heroTitle">
                Learn a Tech Skill and become a pro within months...
              </h1>
              <p>
                Do you feel lost and uncertain about where to begin? Worry not,
                for our dedicated online assistant is readily available to guide
                you on a comprehensive tour of our website. You'll navigate with
                confidence and ease under its expert guidance
              </p>
              <div className="heroBtn flexBTN">
                <button className="btn" data-assist="hh">
                  Explore
                </button>
                <IconBTN data="Welcome! I'm your friendly online assistant here to make your experience enjoyable and hassle-free. Feel free to ask questions or seek guidance anytime. Let's embark on this journey together!" />
              </div>
            </div>
          </div>
          <div className="">
            <img draggable="false" src={techie} style={{ width: "100%" }} />
          </div>
        </section>
          ...
          <div className="container hairCards">
            {profile.map(
              (
                ...
                <div className="hairCard" key={index}>
                  <img
                    src={item.image}
                    style={{
                      width: "100%",
...
function Icon({ data }: { data: string }) {
  return (
    ...
    >
      ...
      <g data-message={data} mask="url(#mask0_302_86)">
        <path
          data-message={data}
          fill="#fff"
